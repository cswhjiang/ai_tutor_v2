...
# from tool_v3 import html_to_image
# from tool_v2 import html_to_image
# from tool import html_to_image

OUT_DIR = Path(r"./shots")
OUT_DIR.mkdir(exist_ok=True)

html = Path(r"test/haibao2.html")
img_file = 'test/shamo_haibao_step2_generation_output0.png'
save_img_name = 'haibao2.png'
#
# html = Path(r"test/haibao_kafei.html")
# img_file = 'test/kafei_step2_generation_output0.png'
# save_img_name = 'haibao_kafei.png'

# html = Path(r"test/duck.html")
# img_file = 'test/duck_step2_generation_output0.png'
# save_img_name = 'duck.png'
...
async def main():
    ...
    img_list = [(img_file, imb_bin)]

    result = await html_to_image(html_code, img_list)
    # print(result)
    if result['status'] == 'success':
        with open(os.path.join(OUT_DIR, save_img_name), 'wb') as f:
