...
class PosterImageGenerationAgent(BaseAgent):
    """专门为基于poster生成配图，使用nano banana。参考图像，并使用prompt"""
    ...
    async def _run_async_impl(self, ctx: InvocationContext) -> AsyncGenerator[Event, None]:
        ...
        # logger.info(draft_results)
        # if 'reference_image_name' not in current_parameters and 'poster_image_to_generate' not in draft_results: # NOTE： PPT一定要有图
